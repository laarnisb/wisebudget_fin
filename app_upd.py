...
# Step 9: Safe conditional execution
if 'df' in st.session_state and st.session_state.exploration_done and st.session_state.cleaning_done and st.session_state.modeling_done:
